...
def policy_value_network(network, add_sigmoid=False):
    ...
    if network == 'wideresnet10':
    ...
    elif network == 'ghostnet05':
        from dlshogi.network.policy_value_network_ghostnet05 import PolicyValueNetwork
    elif network == 'ghostnet10':
        ...
        from dlshogi.network.policy_value_network_mobilenet import PolicyValueNetwork
    else:
